    ...
    <td rowspan="2" valign="top"><form name="form1" method="post" action="sappoinment5.php">
      <table width="200" border="1">
        ...
        <tr>
          ...
          </tr> <?php echo "<input type='hidden' name='t2' value='$s2'> <input type='hidden' name='t0' value='$s0'> <input type='hidden' name='t1' value='$s3'> <input type='hidden' name='t3' value='$sp'>"; ?>
