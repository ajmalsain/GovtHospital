...
<table width="1332" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="530" rowspan="3" valign="top"><div align="center">
        <p class="style1">Staff Registration</p>
	  ...
	  ?>
          <table width="278" border="0">
            ...
            <tr>
			  ...
			  $s="insert into staff(staffID,name,Hname,place,pin,phone,gender,hospID,Stype,qualification,experience,dob,password,estatus) values('$staffID','$s1','$s2','$s3','$s4','$s5','$s6','$s7','$s8','$s10','$s11','$s12','staff@123','A')";
			  mysql_query($s);
			  ...
			  mysql_query($s);
			  echo"<b> Registered Successfully </b><br> Your User ID is $staffID </br> and <br> Password is staff@123</br>" ;
			  ?>
              </div></td>
            </tr>
          </table>
