  ...
  <tr>
    ...
    <td colspan="2" valign="top"><div align="center">
	 ...
	 echo "<tr><td>$row[0]</td><td>$row[1]</td><td>$row[6]</td><td>$row[9]</td><td><form action='onappoinment4.php' method='POST'>
	   <input type='submit' value='view'>
	   	   <input type='hidden' name='t2' value='$staffid'> <input type='hidden' name='t1' value='$s3'> <input type='hidden' name='t3' value='$s2'><input type='hidden' name='c1' value='$s1'> </form></td></tr>";
	 }
	 echo "</table>";
	 ?>
    </div>
