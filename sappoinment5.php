...
<table width="1332" border="0" cellpadding="0" cellspacing="0">
  ...
  <td rowspan="3" valign="top"><div align="center">Consultation Details
    ...
    <form name="form2" method="post" action="sappoinment6.php">
      <table width="191" border="1">
        <tr>
          <td width="181"><div align="center">Booking Date </div></td>
          </tr>
        <tr>
          <td height="23"><div align="center">
            <input name="dt" type="date" id="dt" min="<?php echo date('Y-m-d') ?> ">
          </div></td>
          </tr>
        <tr>
          <td><div align="center">
            <input type="submit" name="Submit2" value="Submit">
			<?php echo "<input type='hidden' name='t2' value='$s2'> <input type='hidden' name='t1' value='$s3'> <input type='hidden' name='t0' value='$s0'> <input type='hidden' name='t3' value='$sp'>"; ?>
          </div></td> 
