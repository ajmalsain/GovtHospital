...
<table width="1400" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="4" valign="top"><div align="center">
        <p class="style1">Staff's Transfer</p>
        <form name="form1" method="post" onSubmit="return abc()" action="stafftransfer2.php">
          <?php
		$s0=$_POST["t0"];
		$s1=$_POST["hospid"];
	  include("connection.php");
	  $s=mysql_query("select* from staff where spl is null");
	  if(mysql_num_rows($s)==0)
	     echo"<b>No Staffavailable";
		 else
		 {
	  ...
	  ?>
          <table width="424" border="0">
            <tr>
              <td width="148">Enter Staff ID </td>
  ...
  <tr>
    ...
    <td colspan="2" rowspan="3" valign="top"><p class="style1">Details</p>      <?php
	  include("connection.php");
	  $s=mysql_query("select * from staff where staffid='$s0' and spl is null");
	  if(mysql_num_rows($s)==0)
	  {
      ...
      <table width="331" border="0">
        ...
        <tr>
          <td colspan="2"><form name="form2" method="post" action="stafftransfer3.php">
    ...
    <td valign="top"><form name="form3" method="post" action="stafftransfer3.php">
        <table width="327" border="1">
          ...
          <tr>
			...
			$s="insert into staffwork values('$s0',$wno,'$s1','$desig','$regdate')";
			mysql_query($s);
			echo "<b>Success....";
			?>&nbsp;</td>
          </tr>
