...
<table width="1332" border="0" cellpadding="0" cellspacing="0">
  ...
  <td rowspan="3" valign="top"><div align="center">Consultation Details
    ...
    <form name="form2" method="post" action="onappoinment6.php">
      <table width="191" border="1">
        ...
        <tr>
          <td><div align="center">
			...
			<?php echo "<input type='hidden' name='t2' value='$s2'> <input type='hidden' name='t1' value='$s3'> <input type='hidden' name='t3' value='$sp'><input type='hidden' name='c1' value='$s1'>"; ?>
          </div></td> 
